            ...
            <div class="container px-6 py-3 mx-auto">
                ...
                <nav  class="p-6 mt-4 text-white bg-black sm:flex sm:justify-center sm:items-center">
                    <div class="flex flex-col sm:flex-row">
                        ...
                        @auth
                            <a href="{{ url('/dashboard') }}" class="mt-3 hover:underline sm:mx-3 sm:mt-0">Dashboard</a>
                        @else
                    <a href="{{ route('login') }}" class="mt-3 hover:underline sm:mx-3 sm:mt-0">Log in</a>

                    @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="mt-3 hover:underline sm:mx-3 sm:mt-0">Register</a>
                                @endif
                            @endauth
